		...
		<view class="content">
			...
			<view class="genaral-area">
				...
				<view class="flex-box tc thead">
					...
					<view class="item-3">表号</view>

					<view class="item-3">企业名称</view>

					<view class="item-3">审核状态</view>
				...
				<view v-for="(item,index) in reportHomeList" :key="index">
					<view class="flex-box table tc">
						...
						<view class="item-3" style="text-decoration: underline;color: #007AFF;" @click="toReportPage(item.pkid)">
							未上报
						</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			toReportPage(pkid){
				uni.navigateTo({
					url:`/pages/report/reportPage?pkid=${pkid}`
				})
